...
* Description: Social link button shows in widget
* Author: mrinal013
...
class Social_Simple_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array( 'description' => __( 'Social link', 'social-simple-widget' ), ) // Args
		);
	...
	public function widget( $args, $instance ) {
		...
		if (!empty($size)) {
			//echo $size;
			if($size == "Small") { $size = "lg"; }
			elseif($size == "Medium") { $size = "3x"; }
			elseif($size == "Large") { $size = "5x"; }
		}
		...
		foreach( $url as $value) {
			...
			$domains = array(
					...
					'instagram', 'github', 'joomla', 'maxcdn', 'deviantart', 
					);
			...
			//if(filter_var($value, FILTER_VALIDATE_URL)) echo "URL";

			if(filter_var($value, FILTER_VALIDATE_URL)) { ?>
			<a href="<?php echo $value; ?>" target="<?php echo $target; ?>" title="<?php echo $site; ?>" class="<?php echo $site; ?>">
				<span class="fa-stack fa-<?php echo $size; ?>" aria-hidden="true">
				  <i class="fa <?php if( $style == 2 ) echo ' fa-circle'; elseif( $style == 3 ) echo ' fa-square'; elseif( $style == 4 ) echo ' fa-square-o'; else echo ' '; ?> fa-stack-2x"></i>
				  <i class="fa fa-<?php echo $site; ?> <?php if( ( $style == 2 ) || ( $style == 3 ) ) echo ' fa-inverse'; else echo ' '; ?> fa-stack-1x"></i>
				</span>
			</a>
	...
	public function update( $new_instance, $old_instance ) {
		...
		public function form( $instance ) {
            ...
            <legend>Style:</legend>
                ...
                <label for="<?php echo ($this->get_field_id( 'style' ) . '-4' ) ?>"><?php _e('Square bordery') ?></label> <br />
            </p>
